...
"""
I followed a different approach and didn't rely on this function in my code. Skipping this test
...
def test_make_sentence():
    ...
    # My function doesn't have a limiter on sentence length
    # ---make-a-sentence-of-6-words---
    sentence = trigrams.make_sentence(tri_dict, trigrams.pick_random_pair(tri_dict))
